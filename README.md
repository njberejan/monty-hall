...
This repository is for the Monty Hall assignment at The Iron Yard in Durham, NC. The assignment was to build a simulation of the Monty Hall problem and to prove that the assertion made below is true:
...
Please run monty_hall.py to run the simulation.
