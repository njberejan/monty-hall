...
This is the readme file for tonight's homework. Please run the monty_hall.py file, it should automatically run the simulation 1000 times and return the results.
